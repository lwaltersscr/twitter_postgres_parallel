...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/lwaltersscr/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/lwaltersscr/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/lwaltersscr/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/lwaltersscr/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/lwaltersscr/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/lwaltersscr/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |         8m 36.57s         |           9.58s           | 
| `pg_normalized_batch`  |         29.96s            |           4.51s           | 
| `pg_denormalized`      |         22.53s            |           3.23s           | 
